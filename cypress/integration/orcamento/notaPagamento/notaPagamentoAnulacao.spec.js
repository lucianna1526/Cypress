    ...
    anulaPagamento() {
       it('ORÇAMENTO: ANP - Anulação de Pagamento', () => {
        ...
        it('Nota de Pagamento / Anulação de Pagamento com valor acima do saldo', () => {
            ...
            cy.get('input[nat="cadastroAnulacaoPagamentoData"]').dblclick().type(formatedDate2PtBR()).wait(2000);

            //Informa o valor da Anulação da pagamento
            cy.get('input[nat="cadastroAnulacaoPagamentoVlLiquido"]').dblclick().type('10,00').wait(1000);           
            ...
            cy.get('.modal-body',{timeout:1000}).should('contain', 'Valor da anulação maior que saldo liquido da nota de pagamento!');
            cy.get('.modal-footer>button').click();
        });     
        
        it('Nota de Pagamento / Anulação de Pagamento com valor dentro do saldo', () => {            
            //Informa o valor da Anulação da pagamento
            cy.get('input[nat="cadastroAnulacaoPagamentoVlLiquido"]').dblclick().type('5,00').wait(1000);           
