class processoComprasDispensaCubataoRequisicao {
  requisicaoCubatao() {
    it("Acessa Modulo Compras", () => {
      ...
      /*for (let i = 0; i < timeout && !found; i++) {
        cy.get("body").then(($body) => {
          if ($body.find('[nat="COMPRAS E LICITAÇÕES"]').length > 0) {
...
export default new processoComprasDispensaCubataoRequisicao();
