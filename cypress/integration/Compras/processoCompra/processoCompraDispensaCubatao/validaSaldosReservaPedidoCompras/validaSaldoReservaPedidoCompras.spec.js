...
/* class validaSaldoReservaPedidoCompras {
  pedidoCompraValidaSaldo() {
  ...
  //---Valida o saldo da reserva, quando o empenho gerado foi no valor total
       ...
       validaSaldoInicialFicha() {
        ...
        it("Reserva de dotação", () => {
          ...
          cy.get('[nat="fichaInfoSaldoAtual"]>div>div>span>span').should("have.text", "R$ 34.989,38").wait(5000);
        }); 
      }
...
export default new validaSaldoReservaPedidoCompras();
