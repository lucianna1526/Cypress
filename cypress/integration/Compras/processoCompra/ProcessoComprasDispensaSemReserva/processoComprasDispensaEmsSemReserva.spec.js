...
class processoComprasDispensaEmsSemReserva {
  emsDispensaSemReserva() {
  ...
  validaEmsDispensaAbaItemSemReserva() {
  ...
  validaEmsDispensaAbaDocumentosSemReserva() {
  ...
  validaEmsDispensaAbaParcelaSemReserva() {
    it("valida soma item na grid documentos", () => {
      cy.get('li[nat="Documentos"]').click().wait(1000);
      cy.get('div[nat="cadastroEmsDocumentoGrid"]').as("grid");
...
export default new processoComprasDispensaEmsSemReserva();
