...
class processoComprasDispensaGeraAutorizacaoCompraSemReserva {
    geraAutorizacaoSemReserva(){        
...
export default new processoComprasDispensaGeraAutorizacaoCompraSemReserva();
