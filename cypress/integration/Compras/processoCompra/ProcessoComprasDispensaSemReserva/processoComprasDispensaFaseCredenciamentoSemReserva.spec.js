...
class processoComprasDispensaFaseCredenciamentoSemReserva {
  credenciamentoSemReserva() {
...
export default new processoComprasDispensaFaseCredenciamentoSemReserva();
