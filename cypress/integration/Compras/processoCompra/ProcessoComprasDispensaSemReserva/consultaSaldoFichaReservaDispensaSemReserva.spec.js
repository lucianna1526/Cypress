...
class consultaSaldoFichaReservaDispensaSemReserva {
  ...
  consultaSaldoFichasInicialSemReserva() {
  ...
  consultaSaldoReservaDotacaoInicialSemReserva() {
  ...
  consultaSaldoExecucaoOrcamentariaInicialSemReserva() {
  ...
  consultaSaldoFichasFinalSemReserva() {
    it("COMPRAS E LICITAÇÕES: Saldo de fichas", () => {
      cy.moduloMenu("COMPRAS E LICITAÇÕES","Saldo de fichas");
    })
  ...
  consultaSaldoExecucaoOrcamentariaFinalSemReserva() {
    it("ORÇAMENTO: Consulta de execução orçamentária", () => {
      cy.moduloMenu("ORÇAMENTO","Consulta de execução orçamentária");
    })
...
export default new consultaSaldoFichaReservaDispensaSemReserva();
