class geraEmpenhoAposAnulacaoSemReserva {
    ...
    validaGeraEmpenhoSaldoCotacaoCanceladoSemReserva(){
    ...
    excluiAnulacaoSaldoCotacaoSemReserva(){
...
cy.get(".md-toast-text").should("have.text", "      Anulação removida com sucesso!    ");
    ...
    geraEmpenhoAposExcluiAnulacaoSemReserva(){
...
export default new geraEmpenhoAposAnulacaoSemReserva();