...
import processoComprasDispensaPedidoCompraSpec from '../ProcessoComprasDispensa/processoComprasDispensaPedidoCompra.spec.js'

class processoCompraDispensaPedidoSimNao {
    validaPedidoSimNao() {
         ...
         if(cy.get('button[title="Abrir pedido de compra"]') == null){
           ...
           .wait(5000)
            ...
            cy.get('[ng-click="fechar()"] > .md-blue-theme')
                ...
                processoComprasDispensaPedidoCompraSpec.pedidoCompraDispensaGeradoSim();
...
export default new processoCompraDispensaPedidoSimNao();
