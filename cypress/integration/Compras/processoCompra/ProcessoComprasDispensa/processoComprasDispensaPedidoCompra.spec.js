...
class processoComprasDispensaPedidoCompra {
  pedidoCompraDispensaGeradoSim() {            
...
export default new processoComprasDispensaPedidoCompra();
